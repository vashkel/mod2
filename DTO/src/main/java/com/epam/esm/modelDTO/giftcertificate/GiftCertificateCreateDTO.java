...
import java.util.Set;
    ...
    @NoArgsConstructor
    @Validated
    public class GiftCertificateCreateDTO extends RepresentationModel<com.epam.esm.modelDTO.giftcertificate.GiftCertificateCreateDTO> implements Serializable {
